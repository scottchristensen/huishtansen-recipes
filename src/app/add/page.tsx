          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Mom's Famous Pasta"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  required
                  value={form.chef}
                  onChange={(e) => update("chef", e.target.value)}
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    name="status"
                    value="want-to-try"
                    checked={form.status === "want-to-try"}
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="radio"
                    name="status"
                    value="family-approved"
                    checked={form.status === "family-approved"}
                    onChange={(e) => update("status", e.target.value)}
                    className="accent-amber-500"
                  />
